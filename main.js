...
define(function (require, exports, module) {
    ...
    var gruntDomain = new NodeDomain("grunt"
                        , ExtensionUtils.getModulePath(module, "node/GruntDomain")
                    );
    ...
    function getTasks() {
        ...
        gruntDomain
            .exec("getTasks", ProjectManager.getProjectRoot().fullPath + path)
            .done(function (tasks) {
    ...
    function runTask(taskName) {
        panel.$panel.find(".grunt-runner")
                    .removeClass("grunt-hide")
                    .html("Running '" + (taskName || 'default') +
                        "' ( <div id='kill-btn' class='btn small'>kill</div> )"
                    );
        $icon.addClass("on");
        gruntDomain
            .exec("runTask", taskName
                , ProjectManager.getProjectRoot().fullPath + path
    ...
    AppInit.appReady(function () {
        ...
        panel.$panel.on("click", "#clear-console", function () {
            clearConsole();
        });
